        ...
        switch (n.label) {
          ...
          case 2:
            if (e = n.sent(), m.syncApi({
                ...
                top: 20,
                left: 20
              }), z(r, B), M(r, cc.Layout.Type.HORIZONTAL, cc.Layout.ResizeMode.CONTAINER), L(r, 572, 80), r.setAnchorPoint(0, .5), i = H("tip-label"), D(i, e.detail, 28, 0, "000000"), z(i, r), e.subTp == v.ClickMore)
              for (c = H("tip-imgs-layout"), z(c, r), c.getPosition().equals, c.setPosition(c.getPosition().add(cc.v2(0, 12))), M(c, cc.Layout.Type.HORIZONTAL, cc.Layout.ResizeMode.CONTAINER, 10), u = function(t) {
          ...
          case 3:
            return n.sent(), L(d, 572, 280), h = H("click-layer"), z(h, f), L(h, 286, 140), d.on(cc.Node.EventType.TOUCH_END, function(t) {
              ...
              var u = H("child-lb"),
                s = D(u, (K.length + 1).toString(), 30, 26);
              z(u, a);
              var l = {
  ...
  var m = function() {
    ...
    T = function(t) {
      for (var n = t.indexOf("="), e = -1 !== n ? n : t.length, r = 3 * (t = t.replace(/=/g, "")).length / 4, i = new Uint8Array(r), o = 0, a = 0; a < e; a += 4) {
        var c = I.indexOf(t.charAt(a)),
          u = I.indexOf(t.charAt(a + 1)),
          s = I.indexOf(t.charAt(a + 2)),
          l = I.indexOf(t.charAt(a + 3)),
          f = c << 2 | u >> 4;
        if (i[o++] = f, -1 !== s) {
          var d = (15 & u) << 4 | s >> 2;
          i[o++] = d
  ...
  r.prototype.decode = function(t) {
    for (var n = "", e = 0; e < t.length;) {
      var r = t[e],
        i = 0,
        o = 0;
      if (r <= 127 ? (i = 0, o = 255 & r) : r <= 223 ? (i = 1, o = 31 & r) : r <= 239 ? (i = 2, o = 15 & r) : r <= 244 && (i = 3, o = 7 & r), t.length - e - i > 0)
        for (var a = 0; a < i;) o = o << 6 | 63 & (r = t[e + a + 1]), a += 1;
      else o = 65533, i = t.length - e;
      n += String.fromCodePoint(o), e += i + 1
    }
    return n
  };
  var S, k = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
    P = (function(t) {
      ! function(n) {
        function e(t, n) {
